...
Java_com_anygames_trans_sdk_OCRPredictorNative_init(
...
Java_com_anygames_trans_sdk_OCRPredictorNative_forward(
...
Java_com_anygames_trans_sdk_OCRPredictorNative_release(
